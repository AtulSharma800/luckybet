...
<html lang="en">
  <head>
    ...
    <!-- Title-->
    <title>Payment Mode For Test Booking || <?=$co_name;?></title>
  ...
  <body>
    ...
    <div class="page-content-wrapper py-3">
		...
		<p style="position: fixed;width: 100%;bottom: 0px;left: 0px;margin-bottom:0px;"><span class="seemore-btn" onclick="book_test()">Continue</span></p>
    </div>
		...
		function book_test()
			{
				...
				$.ajax({
					url: "ajax/book-test.php?test_id="+test_id+"&amount="+amount+"&payment_mode="+payment_mode,
					type: "POST",
					data:  "",
					contentType: false,
					cache: false,
						...
						if(a.status=='Success')
							{
								...
								setTimeout(function(){window.location.href='test-success.php?test_id='+test_id;},1000);
							}
						else	
							{
