<?php
	...
	$query=mysqli_query($con,"insert into booked_test(member_id,lab_id,test_id,test_name,amount,payment_mode,payment_status,status,created_at,modified_at) values('$member_id','0','$test_id','$test_name','$amount','$payment_mode','$payment_status','$status','$created_at','$modified_at')");
	...
	if($res)
		{
			...
			$response['message']="<i class='fa fa-check-circle' aria-hidden='true'></i>&nbsp;&nbsp;Test Booked successfully.";
