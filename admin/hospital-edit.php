			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					$query2=mysqli_query($con,"update hospital set image='$main_image' where id='$id'");
					$res2=mysqli_affected_rows($con);
				}
			
			//insert package details
			$query=mysqli_query($con,"update hospital set name='$name',doctors='$doctors',year='$year',state='$state',city='$city',description='$description',sort_order='$sort_order' where id='$id'");
...
<head>
	...
	<title>Edit Hospital :: <?=$co_name;?></title>
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit Hospital</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Edit Hospital</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Edit Hospital</h6>
								
								<div class="header-elements">
									<a onclick="hospital.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="hospital.php"><span class="badge bg-success badge-pill" style="font-size:14px;">HOSPITAL LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<?php
							$id=$_GET['id'];
							$query=mysqli_query($con,"select * from hospital where id='$id'");
							$res=mysqli_fetch_array($query);
						?>	
						<form action="hospital-edit.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
													...
													<p style="font-size:24px;text-align:center;">
														<?php
															if(!empty($res['image']))
																{
														?>
																	<img src="<?php echo 'upload/hospital/'.$res['image'];?>" style="width:100%;display:block">
														<?php
																}
															else
																{															
										...
										<div class="row">	
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<input type="text" name="year" value="<?=$res['year'];?>" class="form-control" placeholder="1990">
												</div>	
											</div>
											<div class="col-md-3">
												<div class="form-group">
													<label>No of Doctors</label>
													<input type="text" name="doctors" value="<?=$res['doctors'];?>" class="form-control">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
	...
	<?php
		if($update_status==1)
			{
				echo "<script>$.Toast('', 'Hospital updated successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
