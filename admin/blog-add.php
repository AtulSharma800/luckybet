	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into blog(title,category,image,description,seo_url,written_by,status,date_added,time_added) values('$title','$category','$main_image','$description','$seo_url','$written_by','$status','$date','$time')");
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Blog</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="blog.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="blog.php"><span class="badge bg-success badge-pill" style="font-size:14px;">BLOG LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="blog-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
												...
												<div class="form-group">
													...
													<div class="form-check form-check-switch  form-check-switch-left">
														<label class="form-check-label d-flex align-items-center">
															<input type="checkbox" data-on-color="success" data-off-color="danger" data-on-text="Enable" data-off-text="Disable" class="form-check-input-switch" name="status" value="1" checked>
														</label>
													</div>
												</div>
