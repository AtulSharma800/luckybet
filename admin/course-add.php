			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					$extension=$a[1];
					$main_image=preg_replace('/[^a-zA-Z0-9_.]/', '', $title).time().".".$extension;
					move_uploaded_file($_FILES['main_image']['tmp_name'],"upload/courses/$main_image");
				}
			//insert package details
			$query=mysqli_query($con,"insert into courses(title, image, price, overview, requirments, career, duration, qualification) values('$title','$main_image','$price','$overview','$requirment','$career', '$duration', '$qualification')");
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Course</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="course.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="courses.php"><span class="badge bg-success badge-pill" style="font-size:14px;">COURSE LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="course-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
									...
									<fieldset>
										<div class="row">
											<div class="input-field col-md-12">
												...
												<textarea  name="requirment" id="requirment" class="form-control"></textarea>
											</div>
										</div>
									</fieldset>
								</div>
