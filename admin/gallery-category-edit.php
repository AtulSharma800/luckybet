	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"update gallery_category set name='$name',sort_order='$sort_order',date_added='$date_added' where id='$id'");
			$res=mysqli_affected_rows($con);
			if($res)
				{
					echo "<script>alert('Gallery Category Updated Successfully.');</script>";	
				}
			else
				{
...
<head>
	...
	<title>Edit Gallery Category :: <?=$co_name;?></title>
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit Gallery Category</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Edit Gallery Category</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="gallery_category.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="gallery-category.php"><span class="badge bg-success badge-pill" style="font-size:14px;">GALLERY CATEGORY LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<?php
							$id=$_GET['id'];
							$query=mysqli_query($con,"select * from gallery_category where id='$id'");
							$res=mysqli_fetch_array($query);
						?>	
						<form action="gallery-category-edit.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
	...
	<!-- /page content -->
	<script src="js/gallery_category.js"></script>
