...
<head>
	...
	<title>Unapproved Members :: Braj Dham Yatra</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Unapproved Members</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Unapproved Members</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Unapproved Members</h6>
							</div>
							...
							<div class="table-responsive">
								<table class="table datatable-save-state">
									...
									<tbody>
										<?php
											$i=0;
											$query=mysqli_query($con,"select * from member where status='Disable' order by name");
