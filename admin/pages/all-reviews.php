...
<head>
	...
	<title>All Reviews :: Brij Dham Yatra</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - All Reviews</h4>
							...
							<div class="table-responsive">
								<table class="table datatable-save-state">
									...
									<tbody>
										<?php
											$i=0;
											$query=mysqli_query($con,"select review.name,review.rating,review.email,review.message,review.package_id,review.date_added,review.status,review.id from review left join package on review.package_id=package.id");
															...
															<div class="list-icons">
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a onclick="review.enable(<?=$id;?>)" class="dropdown-item"><i class="icon-check"></i> Enable</a>
																		<a onclick="review.disable(<?=$id;?>)" class="dropdown-item"><i class="icon-cross"></i> Disable</a>
