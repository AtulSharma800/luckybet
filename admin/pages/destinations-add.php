	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into destination(name,image,description) values('$name','$main_image','$description')");
			$res=mysqli_affected_rows($con);
			if($res)
				{
					echo "<script>alert('New Destination Added Successfully.');</script>";	
				}
			else
				{
...
<head>
	...
	<title>Add Destination :: Brij Dham Yatra</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Destination</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="destination.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="destinations.php"><span class="badge bg-success badge-pill" style="font-size:14px;">DESTINATION LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="destinations-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
