	...
	if(isset($_GET['id']))
		{
			...
			if($res)
				{
					echo "<script>alert('This enquiry deleted successfully.');window.location.href='pending-enquiry.php';</script>";
				}
		}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Pending Enquiry :: Brij Dham Yatra</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Pending Enquiry</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Pending Enquiry</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Pending Enquiry</h6>
							</div>
								...
								<table class="table datatable-save-state">
									...
									<tbody>
										<?php
											...
											$query=mysqli_query($con,"select * from tour_enquiry where status!='Approved' and status!='Unapproved'");
