...
<head>
	...
	<title>Today Enquiry :: Brij Dham Yatra</title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Today Enquiry</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Today Enquiry</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Today Enquiry</h6>
							</div>
								...
								<table class="table datatable-save-state">
									...
									<tbody>
										<?php
											...
											$query=mysqli_query($con,"select * from tour_enquiry where enquiry_date='$current_date'");
															...
															<div class="list-icons">
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a onclick="enquiry.approve(<?=$id;?>)" class="dropdown-item"><i class="icon-check"></i> Approve</a>
																		<a onclick="enquiry.unapprove(<?=$id;?>)" class="dropdown-item"><i class="icon-cross"></i> Unapprove</a>
