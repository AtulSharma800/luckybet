	...
	if(isset($_POST['submit']))
		{
        	...
        	$query=mysqli_query($con,"UPDATE `users` SET `name`='$name',`mobile`='$mobile',`email`='$email',`gender`='$gender',`dob`='$dob',`city`='$city',`state`='$state',`address`='$address',`password`='$password',`status`='$status',`nominee_name1`='$nominee_name1',`nominee_relation1`='$nominee_relation1',`nominee_age1`='$nominee_age1',`nominee_name2`='$nominee_name2',`nominee_relation2`='$nominee_relation2',`nominee_age2`='$nominee_age2',`nominee_name3`='$nominee_name3',`nominee_relation3`='$nominee_relation3',`nominee_age3`='$nominee_age3',`nominee_name4`='$nominee_name4',`nominee_relation4`='$nominee_relation4',`nominee_age4`='$nominee_age4',`nominee_name5`='$nominee_name5',`nominee_relation5`='$nominee_relation5',`nominee_age5`='$nominee_age5' WHERE id='$id'");
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit User</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="user.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="users.php"><span class="badge bg-success badge-pill" style="font-size:14px;">USERS LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<?php
						    $query=mysqli_query($con,"select * from users where id='".$_GET['user_id']."'");
						    $res=mysqli_fetch_array($query);
						?>	
						<form action="user-edit.php?user_id=<?=$_GET['user_id'];?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
									...
									<fieldset>
										<div class="row">	
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Mobile</label>
													<input type="text" name="mobile" value="<?=$res['mobile'];?>" placeholder="" class="form-control">
												</div>	
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label>Email</label>
													<input type="text" name="email" value="<?=$res['email'];?>" placeholder="" class="form-control">
												</div>	
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label>Password</label>
													<input type="text" name="password" value="<?=$res['password'];?>" placeholder="" class="form-control">
												</div>	
											</div>
											<div class="col-md-3">
												<div class="form-group">
													...
													<select name="gender" class="form-control">
													       ...
													       <option value="Transgender" <?php if($res['gender']=='Transgender'){echo 'selected';} ?>>Transgender</option>
													</select>
												</div>	
											</div>
											...
											<div class="col-md-3">
												<div class="form-group">
													<label>DOB</label>
													<input type='date' name="dob" id="dob" class="form-control" value="<?=$res['dob'];?>">
												</div>	
											</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Address</label>
													<input type='text' name="address" id="address" value="<?=$res['address'];?>" class="form-control">
												</div>	
											</div>
										</div>	
									</fieldset>
									...
									<div class="col-md-12">
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Name</label>
													<input type='text' name="nominee_name1" value="<?=$res['nominee_name1'];?>" class="form-control">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Relation</label>
													<input type='text' name="nominee_relation1" value="<?=$res['nominee_relation1'];?>" class="form-control">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Age</label>
													<input type='text' name="nominee_age1" value="<?=$res['nominee_age1'];?>" class="form-control">
												</div>	
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Name</label>
													<input type='text' name="nominee_name2" class="form-control" value="<?=$res['nominee_name2'];?>">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Relation</label>
													<input type='text' name="nominee_relation2" class="form-control" value="<?=$res['nominee_relation2'];?>">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Age</label>
													<input type='text' name="nominee_age2" class="form-control" value="<?=$res['nominee_age2'];?>">
												</div>	
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Name</label>
													<input type='text' name="nominee_name3" class="form-control" value="<?=$res['nominee_name3'];?>">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Relation</label>
													<input type='text' name="nominee_relation3" class="form-control" value="<?=$res['nominee_relation3'];?>">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Age</label>
													<input type='text' name="nominee_age3" class="form-control" value="<?=$res['nominee_age3'];?>">
												</div>	
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Name</label>
													<input type='text' name="nominee_name4" class="form-control" value="<?=$res['nominee_name4'];?>">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Relation</label>
													<input type='text' name="nominee_relation4" class="form-control" value="<?=$res['nominee_relation4'];?>">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Age</label>
													<input type='text' name="nominee_age4" class="form-control" value="<?=$res['nominee_age4'];?>">
												</div>	
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Name</label>
													<input type='text' name="nominee_name5" class="form-control" value="<?=$res['nominee_name5'];?>">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Relation</label>
													<input type='text' name="nominee_relation5" class="form-control" value="<?=$res['nominee_relation5'];?>">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Age</label>
													<input type='text' name="nominee_age5" class="form-control" value="<?=$res['nominee_age5'];?>">
												</div>	
											</div>
										</div>
									</fieldset>
	...
	<?php
		if($insert_status==1)
			{
				echo "<script>$.Toast('', 'User updated successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
