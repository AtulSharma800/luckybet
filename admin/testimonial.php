<?php
	...
	if(isset($_GET['id']))
		{
			$query=mysqli_query($con,"delete from testimonial where id='".$_GET['id']."'");
			$res=mysqli_affected_rows($con);
			if($res)
				{
					echo "<script>alert('This testimonial deleted successfully.');window.location.href='testimonial.php';</script>";
				}
		}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Testimonial :: <?=$co_name;?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Testimonial</h4>
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a href="testimonial-add.php"><span class="badge bg-success badge-pill">ADD NEW</span></a>
								</div>
							</div>
							...
							<div class="table-responsive">
								<table class="table datatable-save-state">
									...
									<tbody>
										<?php
											$query=mysqli_query($con,"select * from testimonial order by name");
													...
													if(!empty($image_name))
														{
															...
															if(file_exists("upload/thumbs/$new_name"))
																...
																{												
																	$image=resize_image("upload/testimonial/$image_name",100,100);
																}
														}
													else
														{
															...
															<div class="list-icons">
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a href="testimonial-edit.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-pencil-square-o"></i> Edit</a>
																		<a href="testimonial.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-trash-o"></i> Delete</a>
																	</div>
																</div>
															</div>
														</td>
