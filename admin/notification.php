<?php
	...
	if(isset($_GET['id']))
		{
			$query=mysqli_query($con,"delete from notification where id='".$_GET['id']."'");
			$res=mysqli_affected_rows($con);
			if($res)
				{
					echo "<script>alert('This notification deleted successfully.');window.location.href='notification.php';</script>";
				}
		}
?>
<!DOCTYPE html>
...
<head>
	...
	<title>Notification :: <?=$co_name;?></title>
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a href="notification-add.php"><span class="badge bg-success badge-pill">ADD NEW</span></a>
								</div>
							</div>
							...
							<div class="table-responsive">
								<table class="table datatable-save-state">
									...
									<tbody>
										<?php
											$query=mysqli_query($con,"select * from notification order by id desc");
										...
										?>
													<tr>
														<td><a href='upload/notification/<?=$file;?>' target="__blank"><?=$file;?></a></td>
														<td><?=$title;?></td>
														<td><?=$date_added;?></td>
															...
															<div class="list-icons">
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a href="notification-edit.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-pencil-square-o"></i> Edit</a>
																		<a href="notification.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-trash-o"></i> Delete</a>
																	</div>
																</div>
															</div>
														</td>
