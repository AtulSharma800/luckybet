	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into notification(title,image,sort_order,date_added,link) values('$title','$main_image','$sort_order','$date_added','$link')");
			$res=mysqli_affected_rows($con);
			if($res)
				{
					echo "<script>alert('New Notification Added Successfully.');</script>";	
				}
			else
				{
...
<head>
	...
	<title>Add Slider :: <?=$co_name;?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Notification</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Add Notification</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Add Notification</h6>
								
								<div class="header-elements">
									<a onclick="notification.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="notification.php"><span class="badge bg-success badge-pill" style="font-size:14px;">Notification List</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="notification-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
