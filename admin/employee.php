<?php
	...
	if(isset($_GET['id']))
		{
			$query=mysqli_query($con,"delete from employee where id='".$_GET['id']."'");
			$res=mysqli_affected_rows($con);
			if($res)
				{
					echo "<script>alert('This employee deleted successfully.');window.location.href='employee.php';</script>";
				}
		}
?>
<!DOCTYPE html>
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a href="employee-add.php"><span class="badge bg-success badge-pill">ADD NEW</span></a>
								</div>
							</div>
							...
							<div class="table-responsive">
								<table class="table datatable-save-state">
									...
									<tbody>
										...
										?>
													<tr>
														<td><img src="upload/employee/<?=$res['image'];?>" class="img-thumbnail rounded" alt="" style="height:80px;width:100%;object-fit:cover;"></td>
														<td><?=$res['name'];?></td>
															...
															<div class="list-icons">
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a href="employee-edit.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-pencil-square-o"></i> Edit</a>
																		<a onclick="employee.delete(<?=$res['id'];?>)" class="dropdown-item"><i class="fa fa-trash-o"></i> Delete</a>
																	</div>
																</div>
															</div>
														</td>
