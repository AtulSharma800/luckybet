	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into slider(title,link,image,description,sort_order) values('$title','$link','$main_image','$description','$sort_order')");
			$res=mysqli_affected_rows($con);
			if($res)
				{
					echo "<script>alert('New Slider Added Successfully.');</script>";	
				}
			else
				{
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Slider</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="slider.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="slider.php"><span class="badge bg-success badge-pill" style="font-size:14px;">SLIDER LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="slider-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
