			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					move_uploaded_file($_FILES['main_image']['tmp_name'],"upload/attraction/$main_image");
					$query=mysqli_query($con,"update attraction set image='$main_image' where id='$id'");
				}
			
			//insert package details
			$query=mysqli_query($con,"update attraction set title='$title',description='$description',date_added='$date',time_added='$time' where id='$id'");
...
<head>
	...
	<title>Edit Attraction :: <?=$co_name;?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit Attraction</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Edit Attraction</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Edit Attraction</h6>
								
								<div class="header-elements">
									<a onclick="attraction.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="attraction.php"><span class="badge bg-success badge-pill" style="font-size:14px;">ATTRACTION LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<?php
							$id=$_GET['id'];
							$query=mysqli_query($con,"select * from attraction where id='$id'");
							$res=mysqli_fetch_array($query);
						?>	
						<form action="attraction-edit.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="main_image img-thumbnail" onclick="attraction.select_image()">
													<p style="font-size:24px;text-align:center;">
														<?php
															if(!empty($res['image']))
																{
														?>
																	<img src="<?php echo 'upload/attraction/'.$res['image'];?>" style="width:100%;display:block">
														<?php
																}
															else
																{															
