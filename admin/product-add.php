	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into products(name,description,image,price,tax,status,created_at,updated_at,category_ids,discount,unit,related_products) values('$name','$description','$main_image','$price','$tax','$status','$created_at','$updated_at','$category_ids','$discount','$unit','$related_products')");
...
<head>
	...
	<title>Add Product :: <?=$co_name;?></title>
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Product</h4>
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="product.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="products.php"><span class="badge bg-success badge-pill" style="font-size:14px;">PRODUCTS LIST</span></a>
								</div>
							</div>
							<div class="card-body">
								...
								<form action="product-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
	...
	<?php
		if($insert_status==1)
			{
				echo "<script>$.Toast('', 'New product added successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
