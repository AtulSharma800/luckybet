			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					move_uploaded_file($_FILES['main_image']['tmp_name'],"upload/event/$main_image");
				}
			
			//insert package details
			$query=mysqli_query($con,"insert into events(title,location,image,description,date_added,time_added) values('$title','$location','$main_image','$description','$date','$time')");
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Event</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="event2.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="event.php"><span class="badge bg-success badge-pill" style="font-size:14px;">EVENT LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="event-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
