	...
	if(isset($_POST['submit']))
		{
			...
			$requirment=mysqli_real_escape_string($con,$_POST['requirment']);
			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					$extension=$a[1];
					$main_image=time().".".$extension;
					move_uploaded_file($_FILES['main_image']['tmp_name'],"upload/courses/$main_image");
					$query=mysqli_query($con,"update courses set image='$main_image' where id='$course_id'");
				}
			//insert package details
			$query=mysqli_query($con,"update courses set title='$title', price='$price', overview='$overview', requirments='$requirment', career='$career', duration='$duration', qualification='$qualification' where id='$course_id'");
...
<head>
	...
	<title>Add Course :: <?=$website_name;?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit Course</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="course.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="courses.php"><span class="badge bg-success badge-pill" style="font-size:14px;">COURSE LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="course-edit.php?course_id=<?=$_GET['course_id'];?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
							<div class="card card-body border-top-0 rounded-0 rounded-bottom tab-content mb-0">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="main_image img-thumbnail" onclick="course.select_image()">
													<p style="font-size:24px;text-align:center;">	
														<?php
															if(!empty($res['image']))
																{
														?>
																	<img src="<?php echo 'upload/courses/'.$res['image'];?>" style="width:100%;display:block">
														<?php
																}
															else
																{															
									...
									<fieldset>
										...
										<div class="row">	
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Price</label>
													<input type="text" name="price" placeholder="" class="form-control" value="<?=$res['price'];?>">
												</div>	
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label>Duration</label>
													<input type="text" name="duration" placeholder="" class="form-control" value="<?=$res['duration'];?>">
												</div>	
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label>Qualification</label>
													<input type="text" name="qualification" placeholder="" class="form-control" value="<?=$res['qualification'];?>">
												</div>	
											</div>
									...
									<div class="col-md-12">
										...
										<div class="row">
											<div class="input-field col-md-12">
												<label for="textarea1">Overview</label>
												<textarea  name="overview" id="overview" class="form-control"><?=$res['overview'];?></textarea>
											</div>
										</div>
									</fieldset>
									</div>
								...
								<div class="tab-pane fade" id="tab-dark-3">
									<fieldset>
										<div class="row">
											<div class="input-field col-md-12">
												<label for="textarea1">Requirment</label>
												<textarea  name="requirment" id="requirment" class="form-control"><?=$res['requirments'];?></textarea>
											</div>
										</div>
									</fieldset>
								</div>
								...
								<div class="tab-pane fade" id="tab-dark-4">
									<fieldset>
										<div class="row">
											<div class="input-field col-md-12">
												<label for="textarea1">Career:</label>
												<textarea  name="career" id="career" class="form-control"><?=$res['career'];?></textarea>
											</div>
										</div>
									</fieldset>
								</div>
