	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into team(name,image,designation) values('$name','$main_image','$designation')");
...
<head>
	...
	<title>Add Team Member :: <?=$website_name;?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Team Member</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Add Team Member</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="team.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="team.php"><span class="badge bg-success badge-pill" style="font-size:14px;">TEAM</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="team-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
