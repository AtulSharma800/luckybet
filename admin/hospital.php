<?php
	...
	if(isset($_GET['id']))
		{
			$query=mysqli_query($con,"delete from hospital where id='".$_GET['id']."'");
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Hospital</h4>
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a href="hospital-add.php"><span class="badge bg-success badge-pill">ADD NEW</span></a>
								</div>
							</div>
							...
							<div class="table-responsive">
								<table class="table datatable-save-state">
									...
									<tbody>
										<?php
											$query=mysqli_query($con,"select * from hospital order by sort_order");
											while($res=mysqli_fetch_array($query))
												{
													...
													$description=substr(strip_tags($res['description']),100);
										?>
													<tr>
														<td><img src="upload/hospital/<?=$image;?>" class="img-thumbnail rounded" alt=""></td>
														<td><?=$name;?></td>
														<td><?=$doctors;?></td>
														<td><?=$city;?></td>
														<td><?=$description;?></td>
															...
															<div class="list-icons">
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a href="hospital-edit.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-pencil-square-o"></i> Edit</a>
																		<a href="hospital.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-trash-o"></i> Delete</a>
																	</div>
																</div>
															</div>
														</td>
	...
	<?php
		if($delete_status==1)
			{
				echo "<script>$.Toast('', 'Hospital deleted successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
