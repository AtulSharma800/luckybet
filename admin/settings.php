	...
	if(isset($_POST['submit']))
		{
			...
			$help_number=$_POST['help_number'];
			$query=mysqli_query($con,"update settings set help_number='$help_number' where id='1'");
...
<head>
	...
	<title>Settings || Lucky Bet</title>
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Settings</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						?>	
						<form action="settings.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
										...
										<div class="row">	
											<div class="col-md-12">
												<div class="form-group">
													<label>Whatsapp Help Number</label>
													<input type="text" name="help_number" value="<?=$res['help_number'];?>" class="form-control">
												</div>	
											</div>
										</div>	
									</fieldset>
	...
	<script>
	    function update()
	        {
	            if(confirm("Sure ! You want to Update this setting"))
    				{
    					$("#submit").click();
    				}
	        }
