	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into employee(image,name,employee_id,mobile,alternate_mobile,email,password,dob,city,short_description,description,status,date_added,time_added) values('$main_image','$name','$employee_id','$mobile','$alternate_mobile','$email','$password','$dob','$city','$short_description','$description','$status','$date','$time')");
...
<head>
	...
	<title>Add Employee :: <?=$co_name;?></title>
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Employee</h4>
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="employee.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="employee.php"><span class="badge bg-success badge-pill" style="font-size:14px;">EMPLOYEE LIST</span></a>
								</div>
							</div>
							<div class="card-body">
								...
								<form action="employee-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
	...
	<?php
		if($insert_status==1)
			{
				echo "<script>$.Toast('', 'New employee added successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
