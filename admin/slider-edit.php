			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					$query=mysqli_query($con,"update slider set image='$main_image' where id='$id'");
				}
			
			//insert package details
			$query=mysqli_query($con,"update slider set title='$title',description='$description',link='$link',sort_order='$sort_order' where id='$id'");
...
<head>
	...
	<title>Edit Slider :: <?=$co_name;?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit Slider</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="slider.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="slider.php"><span class="badge bg-success badge-pill" style="font-size:14px;">SLIDER LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						?>	
						<form action="slider-edit.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
													...
													<p style="font-size:24px;text-align:center;">
														<?php
															if(!empty($res['image']))
																{
														?>
																	<img src="<?php echo 'upload/slider/'.$res['image'];?>" style="width:100%;display:block">
														<?php
																}
															else
																{															
