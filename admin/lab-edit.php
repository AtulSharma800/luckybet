			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					move_uploaded_file($_FILES['main_image']['tmp_name'],"upload/lab/$main_image");
					$query2=mysqli_query($con,"update lab set image='$main_image' where id='$id'");
					$res2=mysqli_affected_rows($con);
				}
			
			//insert package details
			$query=mysqli_query($con,"update lab set lab_name='$lab_name',licence_no='$licence_no',state='$state',district='$district',area='$area',address='$address',name='$name',login_id='$login_id',mobile='$mobile',alternate_mobile='$alternate_mobile',email='$email',password='$password',dob='$dob',short_description='$short_description',description='$description',status='$status' where id='$id'");
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit Lab</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Edit Lab</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Edit Lab</h6>
								
								<div class="header-elements">
									<a onclick="lab.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="lab.php"><span class="badge bg-success badge-pill" style="font-size:14px;">LAB LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						?>	
						<form action="lab-edit.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="main_image img-thumbnail" onclick="lab.select_image()">
													<p style="font-size:24px;text-align:center;">
														<?php
															if(!empty($res['image']))
																{
														?>
																	<img src="<?php echo 'upload/lab/'.$res['image'];?>" style="width:100%;display:block">
														<?php
																}
															else
																{															
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="lab_name" class="form-control" value="<?=$res['lab_name'];?>">
												</div>	
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Licence No</label>
													<input type="text" name="licence_no" value="<?=$res['licence_no'];?>" class="form-control">
												</div>	
											</div>
											<div class="col-md-4">
												<div class="form-group">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<select class="form-control select-search" id="area" name="area" data-fouc>
														<?php
															$query2=mysqli_query($con,"select * from pharmacy_area where district='".$res['district']."'");
															while($res2=mysqli_fetch_array($query2))
																{
																	$selected="";
																	$id=$res2['id'];
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>Address</label>
													<input type="text" class="form-control" id="address" name="address" value="<?=$res['address'];?>">
												</div>
											</div>	
											<div class="col-md-6">
												<div class="form-group">
	...
	<?php
		if($insert_status==1)
			{
				echo "<script>$.Toast('', 'Lab Details updated successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
