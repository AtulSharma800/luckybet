	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into speciality(name,image,sort_order) values('$name','$main_image','$sort_order')");
...
<head>
	...
	<title>Add Speciality :: <?=$co_name;?></title>
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Speciality</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Add Speciality</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Add Speciality</h6>
								
								<div class="header-elements">
									<a onclick="speciality.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="speciality.php"><span class="badge bg-success badge-pill" style="font-size:14px;">SPECIALITY LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="speciality-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
	...
	<?php
		if($insert_status==1)
			{
				echo "<script>$.Toast('', 'New speciality added successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
