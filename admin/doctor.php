<?php
	...
	if(isset($_GET['id']))
		{
			$query=mysqli_query($con,"delete from doctor where id='".$_GET['id']."'");
...
<body>
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a href="doctor-add.php"><span class="badge bg-success badge-pill">ADD NEW</span></a>
								</div>
							</div>
								...
								<table class="table datatable-save-state">
									<thead>
										<tr>
											...
											<th style="width:17%">Speciality</th>
									...
									<tbody>
										<?php
											$query=mysqli_query($con,"select * from doctor order by sort_order");
										...
										?>
													<tr>
														<td><img src="upload/doctor/<?=$image;?>" class="img-thumbnail rounded" alt=""></td>
														<td><?=$id_no;?></td>
														<td><?=$name;?></td>
														<td><?=$speciality;?></td>
														<td><?=$hospital;?></td>
															...
															<div class="list-icons">
																<div class="dropdown">
																	...
																	<div class="dropdown-menu dropdown-menu-right">
																		<a href="doctor-edit.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-pencil-square-o"></i> Edit</a>
																		<a href="doctor.php?id=<?=$res['id'];?>" class="dropdown-item"><i class="fa fa-trash-o"></i> Delete</a>
																	</div>
																</div>
															</div>
														</td>
	...
	<?php
		if($delete_status==1)
			{
				echo "<script>$.Toast('', 'Doctor deleted successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
