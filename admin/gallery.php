					...
					if(!empty($_FILES['gallery']['name'][$i]))
						{
							...
							move_uploaded_file($_FILES['gallery']['tmp_name'][$i],"upload/gallery/$main_image");
							mysqli_query($con,"insert into gallery(category,image) values('$category','$main_image')");
							$i++;
						}
				}
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<form action="gallery.php?category=<?=@$_GET['category'];?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
								...
								<div class="tab-pane active fade show" id="tab-dark-4">
									<div class="col-md-12">
										<div class="form-group">
											...
											<select type="text" name="gallery_category" id="gallery_category" class="form-control" onchange="change_gallery_category()" required>
