			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					$query=mysqli_query($con,"update city set image='$main_image' where id='$id'");
				}
			
			//insert package details
			$query=mysqli_query($con,"update city set name='$name',description='$description' where id='$id'");
...
<head>
	...
	<title>Edit City :: Dreams Bhoomi</title>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="city.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="city.php"><span class="badge bg-success badge-pill" style="font-size:14px;">CITY LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<?php
							$id=$_GET['id'];
							$query=mysqli_query($con,"select * from city where id='$id'");
							$res=mysqli_fetch_array($query);
						?>	
						<form action="city-edit.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="main_image img-thumbnail" onclick="city.select_image()">
													<p style="font-size:24px;text-align:center;">
														<?php
															if(!empty($res['image']))
																{
														?>
																	<img src="<?php echo 'upload/city/'.$res['image'];?>" style="width:100%;display:block">
														<?php
																}
															else
																{															
