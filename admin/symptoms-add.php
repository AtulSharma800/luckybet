	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into symptoms(name,image,sort_order) values('$name','$main_image','$sort_order')");
...
<head>
	...
	<title>Add Symptoms :: <?=$co_name;?></title>
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Symptoms</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Add Symptoms</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Add Symptoms</h6>
								
								<div class="header-elements">
									<a onclick="symptoms.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="symptoms.php"><span class="badge bg-success badge-pill" style="font-size:14px;">SYMPTOMS LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="symptoms-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
	...
	<?php
		if($insert_status==1)
			{
				echo "<script>$.Toast('', 'New symptoms added successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
