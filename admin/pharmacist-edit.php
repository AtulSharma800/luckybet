			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					$query2=mysqli_query($con,"update pharmacist set image='$main_image' where id='$id'");
					$res2=mysqli_affected_rows($con);
				}
			
			//insert package details
			$query=mysqli_query($con,"update pharmacist set pharmacy_name='$pharmacy_name',licence_no='$licence_no',state='$state',district='$district',area='$area',address='$address',name='$name',login_id='$login_id',mobile='$mobile',alternate_mobile='$alternate_mobile',email='$email',password='$password',dob='$dob',short_description='$short_description',description='$description',status='$status' where id='$id'");
...
<head>
	...
	<title>Edit Pharmacist :: <?=$co_name;?></title>
...
<body>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit Pharmacist</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Edit Pharmacist</span>
						</div>
					...
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								<h6 class="card-title">Edit Pharmacist</h6>
								
								<div class="header-elements">
									<a onclick="pharmacist.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="pharmacist.php"><span class="badge bg-success badge-pill" style="font-size:14px;">PHARMACIST LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						?>	
						<form action="pharmacist-edit.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
													...
													<p style="font-size:24px;text-align:center;">
														<?php
															if(!empty($res['image']))
																{
														?>
																	<img src="<?php echo 'upload/pharmacist/'.$res['image'];?>" style="width:100%;display:block">
														<?php
																}
															else
																{															
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="pharmacy_name" class="form-control" value="<?=$res['pharmacy_name'];?>">
												</div>	
											</div>
											<div class="col-md-6">
												<div class="form-group">
	...
	<?php
		if($insert_status==1)
			{
				echo "<script>$.Toast('', 'Pharmacist Details updated successfully.', 'success', {
										has_icon:false,
										has_close_btn:true,
										stack: true,
										fullscreen:true,
