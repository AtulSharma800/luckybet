			...
			if(!empty($_FILES['main_image']['name']))
				{
					...
					move_uploaded_file($_FILES['main_image']['tmp_name'],"upload/blog/$main_image");
					$query=mysqli_query($con,"update blog set image='$main_image' where id='$id'");
				}
			
			//insert package details
			$query=mysqli_query($con,"update blog set title='$title',description='$description',seo_url='$seo_url',category='$category',written_by='$written_by',status='$status',date_added='$date',time_added='$time' where id='$id'");
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Edit City</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="blog.update()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">UPDATE</span></a><a href="blog.php"><span class="badge bg-success badge-pill" style="font-size:14px;">BLOG LIST</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						?>	
						<form action="blog-edit.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="main_image img-thumbnail" onclick="blog.select_image()">
													<p style="font-size:24px;text-align:center;">
														<?php
															if(!empty($res['image']))
																{
														?>
																	<img src="<?php echo 'upload/blog/'.$res['image'];?>" style="width:100%;display:block">
														<?php
																}
															else
																{															
										...
										<div class="row">	
											...
											<div class="col-md-8">
												<div class="form-group">
													...
													<select name="written_by" class="form-control">
														<option value="0"><?=$co_name;?></option>
														<?php
															$query2=mysqli_query($con,"select * from doctor order by name");
															while($res2=mysqli_fetch_array($query2))
																{
																	$doctor_id=$res2['id'];
																	$doctor_name=$res2['name'];
																	$selected="";
																	if($doctor_id==$res['written_by'])
																		{
																			$selected="selected";
																		}
												...
												<div class="form-group">
													...
													<div class="form-check form-check-switch  form-check-switch-left">
														<label class="form-check-label d-flex align-items-center">
															<input type="checkbox" data-on-color="success" data-off-color="danger" data-on-text="Enable" data-off-text="Disable" class="form-check-input-switch" name="status" value="<?=$res['status'];?>" <?php if($res['status']==1){echo 'checked';} ?>>
														</label>
													</div>
												</div>
											...
											<div class="col-md-12">
												<div class="form-group">
													<label>SEO Url</label>
													<input type="text" name="seo_url" value="<?=$res['seo_url'];?>" class="form-control">
												</div>	
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label>category</label>
													<input type="text" name="category" list="category-list" value="<?=$res['category'];?>" class="form-control">
													<datalist id="category-list">
														<?php
															$query2=mysqli_query($con,"select distinct category from blog order by category");
															while($res2=mysqli_fetch_array($query2))
																{
