	...
	if(isset($_POST['submit']))
		{
			...
			$query=mysqli_query($con,"insert into testimonial(name,image,designation,description) values('$name','$main_image','$designation','$description')");
			$res=mysqli_affected_rows($con);
			if($res)
				{
					echo "<script>alert('New Testimonial Added Successfully.');</script>";	
				}
			else
				{
...
<head>
	...
	<title>Add Testimonial :: <?=$co_name;?></title>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home</span> - Add Testimonial</h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							<div class="card-header header-elements-sm-inline">
								...
								<div class="header-elements">
									<a onclick="testimonial.save()"><span class="badge bg-info badge-pill" style="cursor:pointer;font-size:14px;">SAVE</span></a><a href="testimonial.php"><span class="badge bg-success badge-pill" style="font-size:14px;">Testimonial</span></a>
								</div>
							</div>
							<div class="card-body">
						...
						<form action="testimonial-add.php" method="post" enctype="multipart/form-data" onkeydown="return event.key != 'Enter';">
