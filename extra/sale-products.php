...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Flash Sale">
      ...
      <div class="top-products-area py-3">
        <div class="container">
          ...
          <div class="row g-3" id="product-box">
			<?php
				$query=mysqli_query($con,"select * from products where status='1' and discount!='' limit 0,20");
				...
				if($(window).scrollTop() + $(window).height() > $(document).height() - 3) 
					{
						...
						$.ajax({
							url: "ajax/show-more-sale-product.php?count="+count,
							type: "POST",
							data:  "",
							contentType: false,
							cache: false,
