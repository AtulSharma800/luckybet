    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
          <h6 class="mb-0">Choose Any Category</h6>
        </div>
        <!-- Navbar Toggler-->
					...
					while($res=mysqli_fetch_array($query))
						{
							$category_id=$res['id'];
							$name=$res['name'];
							$image="admin/upload/product/category/".$res['image'];
				?>
							<!-- Single Catagory Card -->
							<div class="col-4">
								<div class="horizontal-product-card">
									<div class="card-body align-items-center" style="padding:5px;box-shadow:2px 2px 4px lightgray;border-radius:10px;">
									  <a class="product-thumbnail d-block" href="product.php?category_id=<?=$category_id;?>"><img src="<?=$image;?>" style="width:100%;object-fit:cover;border-radius:50%;padding:10px;" alt="<?=$name;?>"></a>
									  <a class="product-title d-block image-label two-line" style="padding-bottom:5px;height:42px;" href="product.php?category_id=<?=$category_id;?>"><?=$res['name'];?></a>
									</div>
								</div>
							</div>
							<!-- Single Catagory Card -->
