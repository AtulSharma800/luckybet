    ...
    <div class="page-content-wrapper py-3">
		<div class="weekly-best-seller-area py-3">
			<div class="container" style="margin-bottom:40px;">
				<div class="row g-3">
					<?php
						$query=mysqli_query($con,"select * from hospital order by sort_order asc limit 6");
						while($res=mysqli_fetch_array($query))
							{
					?>
								<div class="col-4">
									<!-- Single Weekly Product Card -->
									<div class="hospital-box" style="padding:10px;">
										<a class="product-thumbnail d-block hospital-image-box" href="doctors.php?hospital_id=<?=$res['id'];?>"><img src="admin/upload/hospital/<?=$res['image'];?>" style="width:100%;object-fit:cover;padding:25px;" alt="<?=$res['name'];?>"></a>
										<a class="product-title d-block image-label two-line" style="height:37px;background:aliceblue;border-radius:15px;margin-top:-15px;" href="doctors.php?hospital_id=<?=$res['id'];?>"><?=$res['name'];?></a>
									</div>
									<!-- Single Weekly Product Card -->
								</div>	
					<?php
