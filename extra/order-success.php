...
<html lang="en">
  <head>
    ...
    <!-- Title-->
    <title>Order Success || <?=$co_name;?></title>
    ...
    <div class="page-content-wrapper py-3" style="margin-top:0px;">
		<div class="container">
			<div class="row" style="align-items:center;height:100vh">
				<div class="col-md-12">
					<center><img src="img/delivery-icon.png" style="height:220px;"></center>
					<p style="text-align:center;margin-top:20px;letter-spacing:1px;font-size:18px;margin-bottom:0px;color:black;">Your Order Has Been Placed Successfully!</p>
					<p style="text-align:center;margin-top:5px;letter-spacing:1px;font-size:15px;font-weight:bold;color:#ED0A0A">Your order id is #<?=$order_no;?></p>
					<p style="text-align:center;margin-top:20px;letter-spacing:1px;font-size:13px;">Your order has been successfully completed.</br>Within moments you will receive a notification with receipt of your purchase and track every step of your order.</p>
					
					<div class="col-lg-12 col-12" style="margin-top:25px;">
						<a class="know-more" href="track-order.php?order_id=<?=$order_id;?>"><i class="fa fa-truck" aria-hidden="true"></i>&nbsp;&nbsp;Track Order</a>
						<a class="consult-now" href="order-detail.php?order_id=<?=$order_id;?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;Order Detail</a>
