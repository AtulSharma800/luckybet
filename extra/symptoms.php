    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
          <h6 class="mb-0">Choose Your Symptoms</h6>
        </div>
        <!-- Navbar Toggler-->
    ...
    <div class="page-content-wrapper py-3">
      <div class="weekly-best-seller-area py-3">
		...
		?>
					<div class="container" style="margin-bottom:40px;">
					  <div class="d-flex align-items-center justify-content-between mb-3" >
						<h5 style='color:#ED0A0A;position:relative;overflow:hidden;width:100%'><?=$res['name'];?><hr style='display: inline-block;   width: 100%; margin-left: 10px; opacity:1;position: absolute; top: -2px;' /></h5>
					  </div>
					  <div class="row g-3">
						<?php
							...
							foreach($symptoms as $symptom_id)
								{
									$query2=mysqli_query($con,"select * from symptoms where id='$symptom_id'");
									...
									<div class="col-6 col-md-6">
									  <div class="horizontal-product-card">
										<div class="card-body align-items-center" style="padding:0px;    background: #EBF9DA; padding: 10px 5px;border-radius: 10px;">
										  <a class="product-thumbnail" style="display: inline-block;    background: white; width: 41px;padding: 5px;border-radius: 10px;" href="speciality.php?id=<?=$res2['id'];?>"><img src="admin/upload/symptoms/<?=$res2['image'];?>" alt="<?=$res2['name'];?>"></a>
										  <a class="product-title image-label" href="speciality.php?id=<?=$res2['id'];?>"><?=$res2['name'];?></a>
										</div>
									  </div>
									</div>
									<!-- Single Weekly Product Card -->
