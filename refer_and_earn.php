    ...
    <div class="header-area" id="headerArea" style='background:#FEF1F1'>
      <div class="container h-100 d-flex align-items-center justify-content-between">
		...
		<?php
			...
			$textencoded=urlencode("To download the app click this link : https://luckybet.co.in/luckybet2.apk");
		?>
        <!-- Navbar Toggler-->
		...
		<div class="container">
			<div class="pt-3">
				<div class="row g-3 upper-icons">
					<div class="col-12">
						<h5 style='letter-spacing:1px;text-align:center;'>Share App</h5>
					</div>
					<div class="col-12">
						<center><img src="img/friend-icon.png" style="width:50px"></center><p style='color:black;text-align:center;margin-top:10px;font-size:11px;'>Share To Friends</p>
					</div>
					<!--<div class="col-2">
						<p style="text-align:center;margin-top:13px;"><i class="fa fa-long-arrow-right" style="color:#ED0A0A;font-size:25px;" aria-hidden="true"></i></p>
					</div>
					<div class="col-6">
						<center><img src="img/earning.png" style="width:50px"></center><p style='color:black;text-align:center;margin-top:10px;font-size:11px;'>3% commission lifetime for each game play.</p>
					</div>-->
				</div>	
			</div>
					...
					<div class="col-12 common-box active-box" id="add-money-box" style="margin-top:0px;background:#FEF1F1">
						<div class="row" style='margin-top:10px;'>
							<div class="col-12 steps active-step" id="step-1">
								<p style='text-align: center;'><a href="https://wa.me/?text=<?=$textencoded;?>"><span class="btn btn-success"><i class="fa fa-whatsapp" aria-hidden="true"></i>&nbsp;&nbsp;SHARE VIA WHATSAPP</span></a></p>
								<!--<p style='margin-top:20px;color:#ED0A0A;letter-spacing:1px;'><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;&nbsp;How to refer a friend ?</p>
								<ul style="font-size:14px;color:black">
									<li style='list-style:decimal;'>Copy the referral code and share it with your friend.</li>
									<li style='list-style:decimal;'>Ask your friend to register on thi app using the referral code.</li>
								</ul>-->
							</div>
						</div>	
					</div>
