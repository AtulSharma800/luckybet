            ...
            <div class="register-form mt-5 px-4">
              <form method="post" id="register-form" enctype="multipart/form-data">
                <div class="form-group text-start mb-4"><span>Full Name</span>
                  ...
                  <input class="form-control required" id="name" name="name" type="text" value="<?=$res['name'];?>" placeholder="Designing World">
                </div>
                
				<div class="form-group text-start mb-4"><span>Mobile No</span>
                  <label for="email"><i class="lni lni-envelope"></i></label>
                  <input class="form-control required" id="mobile" name="mobile" type="text" value="<?=$res['mobile'];?>" placeholder="9999999999" readonly>
                </div>
				
				<div class="form-group text-start mb-4"><span>Email</span>
                  <label for="email"><i class="lni lni-envelope"></i></label>
                  <input class="form-control required" id="email" name="email" type="email" placeholder="help@example.com" value="<?=$res['email'];?>">
                </div>
				
                <button class="btn btn-warning btn-lg w-100 submit-btn" id="submit-btn" onclick="member.update()" type="button" >UPDATE</button>
              </form>
            </div>
            <!-- Login Meta-->
          </div>
